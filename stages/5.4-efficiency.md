...
Financial Reports and Key Metrics are now being tracked continously as you start to hit efficiency. You will most probably need to have a round of funding at this stage as there would be many experiments you have to do before you find the efficient way of aqquiring customers.

As the sales engine starts working overtime, you will also start to have increased costs and possibly start hiring more people. Its a good time to also learn about how to interview and select the right people and also how to leave them with dignity if the hire is not doing well.
